...
import com.hc.myeventbus.util.EventBusException;
import com.hc.myeventbus.util.SubscriberMethodFinder;
...
public class EventBus {
    ...
    private boolean postSingleEventForEventType(Object event, PostingThreadState postingState, Class<?> eventClass) {
        ...
        synchronized (this) {
            //获取这个类对应的订阅方法的列表，每个 EventClass 对应一个列表
